...
export default function Footer() {
  return (
    <footer id="contact" className="bg-[#121212] text-white py-32 px-6 md:px-12 lg:px-24 border-t border-white/5 flex flex-col items-center justify-center text-center">
      <div className="max-w-4xl">
        <h2 className="text-5xl md:text-7xl font-bold tracking-tighter mb-8">
          Let&apos;s Work <span className="text-white/80">Together</span>
        </h2>
        <p className="text-lg md:text-2xl text-white/60 mb-12 leading-relaxed font-light">
      ...
      <div className="w-full mt-32 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between text-xs text-white/40 font-medium tracking-widest uppercase">
